...
module.exports = function (app) {
    ...
    app.route('/api/glreport/:type/:date').all(accountsPolicy.isAllowed)
        ...
        .get(accounts.setReportCondition, accounts.getCompany, accounts.getAccounts, accounts.generateGlDaily, accounts.getAccountchart, accounts.returnGlreport);
    ...
    app.route('/api/glreport/excel/:type/:date/:enddate')
        ...
        .get(accounts.setReportCondition, accounts.getCompany, accounts.getAccounts, accounts.generateGlDaily, accounts.getAccountchart, accounts.exportExcel);
